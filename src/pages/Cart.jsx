  ...
  return (
    <>
      <motion.main
        ...
        <div className="w-full md:w-[calc(100%-420px)] h-fit bg-white ">
          <div className="w-full h-fit gap-5 p-5 font-quicksand flex hpk:flex-row flex-col justify-between items-start hpk:items-center border-b-2 border-b-noHover border-opacity-20">
            ...
            <div className="flex flex-row justify-between hpk:justify-end items-center gap-4 w-full hpk:w-auto hpk:gap-8 self-end">
              ...
              <div className="flex flex-row hpk:flex-col items-center gap-6 hpk:gap-4">
                <h3 className="text-lg font-bold">$ 56.00</h3>
                <div className="flex flex-row gap-4 items-center px-1 border-2 border-noHover rounded-full ">
                  <svg className="fill-navigator" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p className="text-xl text-noHover font-medium">12</p>
                  <svg className="fill-navigator" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <aside className={`hpk:w-[380px] w-full fixed md:sticky h-full bg-white ${payIsOpen? 'top-24' : 'top-[calc(100vh-60px)]'}  right-0 hpk:right-3 md:top-24  rounded-xl overflow-hidden shadow-xl transition-all duration-300`} id="aside">
          <header onClick={() => setPayIsOpen(!payIsOpen)} className="px-6 py-4 bg-navigator font-quicksand font-semibold text-HDark text-xl flex items-center gap-3" id="checkout">Checkout
            {payIsOpen? (
              <svg className="md:hidden fill-white" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="px-4 py-4 bg-white flex flex-col gap-5">
            <h1 className="font-quicksand text-HLig font-bold text-2xl ">Total Cost : $ 56.00</h1>
            <div className="h-0.5 bg-opacity-50 w-full bg-noHover rounded-full"></div>
            <div className="py-3 px-6 w-full bg-noHover bg-opacity-10 flex justify-between rounded-lg">
              <h3 className="font-quicksand text-xl font-semibold text-HLig ">Enter Coupon</h3>
              <h3 className="font-quicksand text-xl font-bold text-navigator">Apply</h3>
            </div>
            <div className="w-full py-3 px-6 bg-noHover bg-opacity-10 rounded-lg">
              <select name="" id="" className="w-full outline-none bg-transparent p-0 font-quicksand text-xl font-semibold text-HLig ">
                <option value="" className="">Payment Method</option>
                <option value="" className="">Paypal</option>
                <option value="" className="">Go-pay</option>
                <option value="" className="">Mandiri</option>
                <option value="" className="">Visa</option>
              </select>
            </div>
            <div className=" w-full px-6 py-3 bg-noHover bg-opacity-10 rounded-lg">
              <label className="font-quicksand text-xl font-semibold text-HLig" htmlFor="Shipping">Shipping Address</label>
            ...
            <button className="px-6 py-3 w-full  bg-navigator text-white text-xl flex items-center justify-center gap-3 font-quicksand font-semibold rounded-lg border-2 mt-6 border-navigator hover:bg-transparent hover:text-navigator transition-all duration-300">
