...
const Vegetables = () => {
	...
	const sayur = useSelector((state) => state.products.sayur)
	...
	return (
		<>
			...
			>
				...
				<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1, transition: { delay: 0.5, duration: 0.5, ease: 'easeIn' } }} className="w-full md:w-[calc(100%-320px)]  ">
					<section className="mt-7 md:mt-14 px-2 sm:px-3 lg:pr-24 xl:pr-40">
						<h1 className=" text-3xl hpk:text-4xl font-quicksand font-bold dark:text-white">Vegetables</h1>
			...
			<footer className="w-full bg-navigator dark:bg-darkNav mt-6">
