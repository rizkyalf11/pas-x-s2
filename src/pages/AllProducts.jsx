				...
				>
					<div className="font-quicksand text-lg font-medium text-HLig dark:text-HDark flex flex-col items-start gap-2">
						...
						<div className="flex gap-2 items-center">
							...
							<input onChange={(e) => setMaxCustomValue(Number(e.target.value))} onClick={(e) => hdlMaxCustom(e)} ref={maxCostum} type="text" className="h-6 w-28 text-lg text-HLig px-2 font-semibold outline-none rounded-md" placeholder="Max Value" id="mx" />
						</div>
						<div className="flex gap-2 items-center">
							<label htmlFor="mn" className="">
								Min. $
							</label>
							<input onChange={(e) => setMinCustomValue(Number(e.target.value))} onClick={(e) => hdlMinCustom(e)} ref={minCostum} type="text" className="h-6 w-28 text-lg text-HLig px-2 font-semibold outline-none rounded-md" placeholder="Min Value" id="mn" />
						</div>
						<div className="flex items-center gap-2">
