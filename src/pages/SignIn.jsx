    ...
    <div className="w-full h-screen flex justify-center items-center">
      ...
      <div className="flex gap-14 mt-16">
        <div className="cursor-pointer">
          <p className="font-quicksand text-2xl font-bold border-b-2 py-1 transition-all duration-300 border-b-navigator dark:text-white">Sign In</p>
        </div>
        <div className="cursor-pointer" onClick={() => {
            navigate('/signup')
          }}>
          <p className="font-quicksand text-2xl font-bold border-b-2 py-1 transition-all duration-300  hover:border-b-navigator dark:text-white">Sign Up</p>
        </div>
      </div>
