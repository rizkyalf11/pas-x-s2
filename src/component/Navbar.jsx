	...
	return (
		<>
			...
			<header className="h-[80px] bg-navigator dark:bg-darkNav flex flex-row items-center justify-between gap-1 hpsk:gap-3 hpk:gap-0 px-2 hpsk:px-3 lg:px-24 xl:px-40 fixed inset-x-0 top-0 shadow-xl z-40 ">
				{route === '/all-products' || route === '/local-fruits' || route === '/import-fruits' || route === '/vegetables' || route === '/beverages' || route === '/cart' ? (
				...
				<img src={logo} alt="logo" className="h-[55px] hidden lg:block cursor-pointer" onClick={() => navigate('/')} />
				...
				<div className=" flex flex-row items-center gap-3 hp:gap-4">
					{route !== '/all-products' && route !== '/local-fruits' && route !== '/import-fruits' && route !== '/vegetables' && route !== '/beverages' ? (
						...
						<>
							<img src={heart} alt="Wishlist" className="w-[28px] hidden md:block md:w-[32px] cursor-pointer" />
