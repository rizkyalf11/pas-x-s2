...
const Navbar = () => {
  ...
  const cardVariants = {
	...
	return (
		<header className="h-[80px] bg-navigator dark:bg-slate-700 flex flex-row items-center justify-between gap-1 hpsk:gap-3 hpk:gap-0 px-2 hpsk:px-4 hpk:px-10 lg:px-20 fixed inset-x-0 top-0 shadow-xl z-30 ">
			...
			<div className=" flex flex-row items-center gap-3 hp:gap-4">
				...
				<div className=" flex flex-row gap-2 items-center cursor-pointer" id="profile">
					...
					<img onClick={() => (isShowCardProfile ? setIsShowCardProfile(false) : setIsShowCardProfile(true))} className="w-[35px] aspect-square object-cover rounded-full lg:w-[50px]" src={person} alt="You" />
				</div>
			</div>
				...
				{isShowCardProfile && (
					...
					>
						...
						<div className=" flex flex-col gap-3 ml-5 mt-2">
							<div className="font-quicksand text-[#8b8b8b] dark:text-white dark:hover:text-navigator hover:text-navigator flex flex-row items-center gap-4 group">
							...
							<div className="font-quicksand text-[#8b8b8b] dark:text-white dark:hover:text-navigator hover:text-navigator group flex flex-row items-center gap-4">
