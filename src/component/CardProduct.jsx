...
import { minusProduct } from "../features/Products/ProductsSlice"
...
const CardProduct = ({product}) => {
  ...
  return (
    <div className="bg-white dark:bg-darkNav shadow-xl h-[250px] rounded-2xl relative flex transition-all duration-300 overflow-hidden group/parent overflow-y-hidden">
      ...
      <div className="absolute cursor-pointer w-8 h-8 hpk:w-10 hpk:h-10 rounded-full top-3 right-3 bg-white dark:bg-darkNav z-20 flex  lg:opacity-0 group-hover/parent:opacity-100 justify-center items-center transition-all duration-300 " id="love">
