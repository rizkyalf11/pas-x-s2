...
const CardDetail = ({ product }) => {
	...
	const hdlAddToCart = (val) => {
		disptach(addToCart(val.product))
				...
				<div className="w-full h-4/6 md:w-3/5 md:h-full  p-4 md:p-6 flex flex-col justify-between ">
					...
					<div className=" h-[75%] mt-4 overflow-y-auto scrollbar-thin scrollbar-thumb-navigator">
						<div className=" w-full h-auto box-border">
							...
							<h3 className=" font-bold text-xl text-HLig leading-10 dark:text-HDark">
								Stock : <span className="text-TexLig font-medium dark:text-TexDark">{stokDetail != null? stokDetail : dataProd.stok}</span>
							</h3>
					...
					<div className="w-full flex justify-between gap-3 items-center">
						<div className="flex gap-3 flex-row">
							{stokDetail != 0 ? (
								...
								<button className="h-[50px] select-none cursor-default w-[180px] border-[2.5px] border-gray-500 bg-gray-500 rounded-xl flex justify-center items-center gap-2 ">
